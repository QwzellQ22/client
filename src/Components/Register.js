...
function Register() {
  ...
  return (
    <div className="container py-5 box">
      ...
      <p className="text-dark">Please register to authenticate</p>
      <hr />
      <div className="text-danger mb-3" onChange={() => setValidasi(validasi)}>
        {validasi}
      </div>
      ...
      <div className="form-group">
        <button className="btn btn-success mt-3 rounded-5" onClick={register}>
          Register
        </button>
      </div>
